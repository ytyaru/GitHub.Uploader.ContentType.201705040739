...
#from ContentType import ContentTypeContentType
#from requests.structures import CaseInsensitiveDict
#from MimeType import MimeType
#from SubType import SubType
import requests
class TestResponse_BlackBox(unittest.TestCase):
    def test_Get_Json(self):
        ...
        response = Response()
        res = response.Get(r)
        self.assertTrue(hasattr(response.Headers, 'ContentType'))
#        self.assertEqual('application/json', response.Headers.ContentType.mime_type)
        self.assertEqual('application/json', response.Headers.ContentType.MimeType.String)
...
#        self.assertEqual('text/html', response.Headers.ContentType.mime_type)
        self.assertEqual('text/html', response.Headers.ContentType.MimeType.String)
